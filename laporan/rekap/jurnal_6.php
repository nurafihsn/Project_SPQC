		...
		<table class="adminlist mb-3" border="1" width="500" cellpadding="5" >
			<thead>
				<tr class="text-center" >
			            <th rowspan="2"></th> <th colspan="2">LSTG</th><th  colspan="3">6R1</th><th colspan="3">KF</th><th colspan="6">CR</th><th colspan="2">F.CoaL</th><th colspan="1">CF</th><th colspan="1">RC</th>
			        </tr>
			    <tr bgcolor="#8080FF" style="color:#FFFFFF">
			        <th>SiO2</th><th>CaO</th><th>LSF</th><th>SIM</th><th>ALM</th><th>LSF</th><th>SIM</th><th>ALM</th><th>FCaO</th><th>LSF</th><th>SIM</th><th>ALM</th><th>C3S</th><th>C3A</th><th>H2O</th><th>ASH</th><th>SILO</th><th>H2O</th>
			    </tr> 
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				 ...
				 <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        $max_query = mysqli_query($conn, "SELECT MAX(SiO2_lstg) AS max_sio2lstg, MAX(CaO_lstg) AS max_cao, MAX(LSF_r1) AS max_lsfr1, MAX(SIM_r1) AS max_simr1, MAX(ALM_r1) AS max_almr1, MAX(LSF_kf) AS max_lsfkf, MAX(SIM_kf) AS max_simkf, MAX(ALM_kf) AS max_almkf, MAX(FLIME_cr) AS max_fcaocr, MAX(LSF_cr) AS max_lsfcr, MAX(SIM_cr) AS max_simcr, MAX(ALM_cr) AS max_almcr, MAX(C3S_cr) AS max_c3scr, MAX(C3A_cr) AS max_c3acr, MAX(fcH2O_fc) AS max_h2ofc , MAX(ASH_fc) AS max_ashfc,  'HE', MAX(rcH2O_fc) AS max_h2orc  FROM lhk_2024 WHERE TANGGAL  = '$tgl'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			     ...
			     <tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    if (isset($_GET['tgl'])) {
					    ...
					    $kolom = array("sio2lstg", "cao", "lsfr1", "simr1", "almr1", "lsfkf", "simkf", "almkf", "fcaocr","lsfcr", "simcr", "almcr", "c3scr","c3acr", "h2ofc", "ashfc");
