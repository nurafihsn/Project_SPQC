...
<body>
		<?php
	    $page = isset($_GET['page']) ? $_GET['page'] : 'ind2';
	    ?>
		<div>
		    <?php if ($page == 'ind2') : ?>
		        ...
		        <div>
		            <h5 class="text-center">RAW MATERIAL TO STORAGE II</h5>
		            <table class="table table-striped table-bordered table-hover">
		                <thead>
		                    <tr class="text-center">
		                        <th colspan="1"></th><th colspan="6">Chemical Composition</th><th colspan="2"></th>
		                    </tr>
	...
	<div >
	<h5 class="text-center">RAWMIX 2R1</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
	...
	<div >
	<h5 class="text-center">KILN FEED W1</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				?>
					    ...
					    <tr>
					        ...
					        <td class="<?php echo $w_almkf; ?>"><?php echo $d['BF_kf']; ?></td>
...
<div >
	<h5 class="text-center">CLINKER W1</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
	...
	<div >
	<h5 class="text-center">FINE COAL</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>

					<tr class="text-center" >
			          <th colspan="1"></th><th colspan="1"> RAW COAL</th> <th colspan="3">FINE COAL 2K1</th>
			        </tr>
	...
	<div >
	<h5 class="text-center">CEMENT TYPE KHUSUS</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>

					<tr class="text-center" >
			          <th colspan="1"></th><th colspan="7">OPC / OWC / TYPE V / TYPE II</th>  <th rowspan="2" >TYPE</th> <th rowspan="2" >CM</th>
			        </tr>

					<tr class="bg-primary text-white">
						
						<th>JAM</th> <th>Blaine</th> <th>SO3 </th><th>45u </th> <th>LOI</th> <th>F.Cao</th>
					</tr>
				</thead>
	...
	<div >
	<h5 class="text-center">CEMENT 2Z1</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
	...
	<h5 class="text-center"></h5>
		<table class="adminlist mb-3 " border="1" width="500" cellpadding="5"  >
			...
			<thead>
					<tr class="text-center" >
			            <th rowspan="1"></th><th colspan="7">CLINKER FEEDER TO CM</th>
			        </tr>
					<tr bgcolor="#8080FF" style="color:#FFFFFF">
				        <th></th>
			...
			<thead>
					<tr class="text-center" >
			            <th rowspan="1"></th><th colspan="7">Clinker Factor</th>
			        </tr>
					<tr bgcolor="#8080FF" style="color:#FFFFFF">
				        <th></th>
	...
	<a href="?page=ind3&tgl=<?php echo isset($tgl) ? $tgl : ''; ?>" class="btn btn-primary">Next Page</a>
            </div>
        <?php endif; ?>
    </div>
	...
	<div >
	<h5 class="text-center">RAW MATERIAL TO STORAGE III</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
	...
	<div >
	<h5 class="text-center">RAWMIX 3R2</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				while ($d = mysqli_fetch_array($q)) {
							...
							$w_almr1 = '';
							if ($d['ALM_r2'] < 1.4 || $d['ALM_r2'] > 1.8) {
							    $w_almr1 = 'text-danger';
							}
					        $w_lsfr1 = '';
							if ($d['LSF_r2'] < 88 || $d['LSF_r2'] > 104) {
							    $w_lsfr1 = 'text-danger';
							}
							$w_simr1 = '';
							if ($d['SIM_r2'] < 2.1 || $d['SIM_r2'] > 2.5) {
							    $w_simr1 = 'text-danger';
							}
				?>
					    ...
					    <tr>
					        <td><?php echo $d['JAM']; ?></td>
					        <td class="<?php echo $w_lsfr1; ?>"><?php echo $d['LSF_r2']; ?></td>
					        <td class="<?php echo $w_simr1; ?>"><?php echo $d['SIM_r2']; ?></td>
					        <td class="<?php echo $w_almr1; ?>"><?php echo $d['ALM_r2']; ?></td>
					        <td class="<?php echo $w_90ur1; ?>"><?php echo $d['r290u']; ?></td>
					        <td class="<?php echo $w_180ur1; ?>"><?php echo $d['r2180u']; ?></td>
					        <td class="<?php echo $w_h2or1; ?>"><?php echo $d['H2O_r2']; ?></td>
					    </tr>
					<?php
					}
					?>
	...
	<div >
	<h5 class="text-center">KILN FEED W2</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				while ($d = mysqli_fetch_array($q)) {
							...
							$w_h2okf = '';
							if ($d['H2O_kf2'] < 0.3 || $d['H2O_kf2'] > 0.7) {
							    $w_h2okf = 'text-danger';
							}
							$w_almkf = '';
							if ($d['ALM_kf2'] < 1.4 || $d['ALM_kf2'] > 1.8) {
							    $w_almkf = 'text-danger';
							}
					        $w_simkf = '';
							if ($d['SIM_kf2'] < 2.1 || $d['SIM_kf2'] > 2.5) {
							    $w_simkf = 'text-danger';
							}
							$w_lsfkf = '';
							if ($d['LSF_kf2'] < 94 || $d['LSF_kf2'] > 98) {
							    $w_lsfkf = 'text-danger';
							}
				?>
					    ...
					    <tr>
					        <td><?php echo $d['JAM']; ?></td>
					        <td class="<?php echo $w_lsfkf; ?>"><?php echo $d['LSF_kf2']; ?></td>
					        <td class="<?php echo $w_simkf; ?>"><?php echo $d['SIM_kf2']; ?></td>
					        <td class="<?php echo $w_almkf; ?>"><?php echo $d['ALM_kf2']; ?></td>
					        <td class="<?php echo $w_almkf; ?>"><?php echo $d['BF_kf2']; ?></td>
					        <td class="<?php echo $w_90ukf; ?>"><?php echo $d['kf290u']; ?></td>
					        <td class="<?php echo $w_180ukf; ?>"><?php echo $d['kf2180u']; ?></td>
					        <td class="<?php echo $w_h2okf; ?>"><?php echo $d['H2O_kf2']; ?></td>
					    </tr>
					<?php
					}
					?>
...
<div >
	<h5 class="text-center">CLINKER W2</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				while ($d = mysqli_fetch_array($q)) {
							...
							$w_almcr = '';
							if ($d['ALM_cr2'] < 1.3 || $d['ALM_cr2'] > 1.9) {
							    $w_almcr = 'text-danger';
							}
					        $w_simcr = '';
							if ($d['SIM_cr2'] < 2 || $d['SIM_cr2'] > 2.6) {
							    $w_simcr = 'text-danger';
							}
							$w_lsfcr = '';
							if ($d['LSF_cr2'] < 93 || $d['LSF_cr2'] > 97) {
							    $w_lsfcr = 'text-danger';
							}
							$w_ltwcr = '';
							if ($d['LTW_cr2'] < 1050 || $d['LTW_cr2'] > 1250) {
							    $w_ltwcr = 'text-danger';
 							}
				?>
					    ...
					    <tr>
					        <td><?php echo $d['JAM']; ?></td>
					        <td class="<?php echo $w_ltwcr; ?>"><?php echo $d['LTW_cr2']; ?></td>
					        <td><?php echo $d['TEMP_cr2']; ?></td>
					        <td class="<?php echo $w_flime; ?>"><?php echo $d['FLIME_cr2']; ?></td>
					        <td class="<?php echo $w_lsfcr; ?>"><?php echo $d['LSF_cr2']; ?></td>
					        <td class="<?php echo $w_simcr; ?>"><?php echo $d['SIM_cr2']; ?></td>
					        <td class="<?php echo $w_almcr; ?>"><?php echo $d['ALM_cr2']; ?></td>
					        <td class="<?php echo $w_c3scr; ?>"><?php echo $d['C3S_cr2']; ?></td>
					        <td><?php echo $d['C3A_cr2']; ?></td>
					    </tr>
					<?php
					}
					?>
	...
	<div >
	<h5 class="text-center">FINE COAL 3K2</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>

					<tr class="text-center" >
			          <th colspan="1"></th> <th colspan="3">FINE COAL 2K1</th>
			        </tr>
	...
	<div >
	<h5 class="text-center">CEMENT 3Z2</h5>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				?>
					    ...
					    <tr>
					        ...
					        <td class="<?php echo $w_fcaoopc; ?>"><?php echo $d['FCaO_z2opc']; ?></td>
	...
	<h5 class="text-center"></h5>
		<table class="adminlist mb-3 " border="1" width="500" cellpadding="5"  >
				<thead>
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_lsAVG2']; ?></td>
				            <td><?php echo $d['Al2O3_lsAVG2']; ?></td>
				            <td><?php echo $d['Fe2O3_lsAVG2']; ?></td>
				            <td><?php echo $d['CaO_lsAVG2']; ?></td>
				            <td><?php echo $d['MgO_lsAVG2']; ?></td>
				            <td><?php echo $d['SO3_lsAVG2']; ?></td>
				            <td><?php echo $d['H2O_lsAVG2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_lsSD2']; ?></td>
				            <td><?php echo $d['Al2O3_lsSD2']; ?></td>
				            <td><?php echo $d['Fe2O3_lsSD2']; ?></td>
				            <td><?php echo $d['CaO_lsSD2']; ?></td>
				            <td><?php echo $d['MgO_lsSD2']; ?></td>
				            <td><?php echo $d['SO3_lsSD2']; ?></td>
				            <td><?php echo $d['H2O_lsSD2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_ssAVG2']; ?></td>
				            <td><?php echo $d['Al2O3_ssAVG2']; ?></td>
				            <td><?php echo $d['Fe2O3_ssAVG2']; ?></td>
				            <td><?php echo $d['CaO_ssAVG2']; ?></td>
				            <td><?php echo $d['MgO_ssAVG2']; ?></td>
				            <td><?php echo $d['SO3_ssAVG2']; ?></td>
				            <td><?php echo $d['H2O_ssAVG2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_ssSD2']; ?></td>
				            <td><?php echo $d['Al2O3_ssSD2']; ?></td>
				            <td><?php echo $d['Fe2O3_ssSD2']; ?></td>
				            <td><?php echo $d['CaO_ssSD2']; ?></td>
				            <td><?php echo $d['MgO_ssSD2']; ?></td>
				            <td><?php echo $d['SO3_ssSD2']; ?></td>
				            <td><?php echo $d['H2O_ssSD2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td  class="<?php echo $w_sio2cl; ?>"><?php echo $d['SiO2_clAVG2']; ?></td>
				            <td  class="<?php echo $w_al2o3cl; ?>"><?php echo $d['Al2O3_clAVG2']; ?></td>
				            <td><?php echo $d['Fe2O3_clAVG2']; ?></td>
				            <td><?php echo $d['CaO_clAVG2']; ?></td>
				            <td><?php echo $d['MgO_clAVG2']; ?></td>
				            <td><?php echo $d['SO3_clAVG2']; ?></td>
				            <td><?php echo $d['H2O_clAVG2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_is2']; ?></td>
				            <td><?php echo $d['Al2O3_is2']; ?></td>
				            <td class="<?php echo $w_fe2o3is; ?>"><?php echo $d['Fe2O3_is2']; ?></td>
				            <td><?php echo $d['CaO_is2']; ?></td>
				            <td><?php echo $d['MgO_is2']; ?></td>
				            <td><?php echo $d['SO3_is2']; ?></td>
				            <td><?php echo $d['H2O_is2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td class="<?php echo $w_sio2lscm; ?>"><?php echo $d['SiO2_lscm2']; ?></td>
				            <td class="<?php echo $w_al2o3lscm; ?>"><?php echo $d['Al2O3_lscm2']; ?></td>
				            <td><?php echo $d['Fe2O3_lscm2']; ?></td>
				            <td class="<?php echo $w_caolscm; ?>"><?php echo $d['CaO_lscm2']; ?></td>
				            <td><?php echo $d['MgO_lscm2']; ?></td>
				            <td><?php echo $d['SO3_lscm2']; ?></td>
				            <td class="<?php echo $w_h2olscm; ?>"><?php echo $d['H2O_lscm2']; ?></td>
			...
			<thead>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_opc2']; ?></td>
				            <td><?php echo $d['Al2O3_opc2']; ?></td>
				            <td><?php echo $d['Fe2O3_opc2']; ?></td>
				            <td><?php echo $d['CaO_opc2']; ?></td>
				            <td><?php echo $d['FK_opc2']; ?></td>
				            <td><?php echo $d['est_opc2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_pcc2']; ?></td>
				            <td><?php echo $d['Al2O3_pcc2']; ?></td>
				            <td><?php echo $d['Fe2O3_pcc2']; ?></td>
				            <td><?php echo $d['CaO_pcc2']; ?></td>
				            <td><?php echo $d['FK_pcc2']; ?></td>
				            <td><?php echo $d['est_pcc2']; ?></td>
				...
				<tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    ?>
				            ...
				            <td><?php echo $d['SiO2_ppc2']; ?></td>
				            <td><?php echo $d['Al2O3_ppc2']; ?></td>
				            <td><?php echo $d['Fe2O3_ppc2']; ?></td>
				            <td><?php echo $d['CaO_ppc2']; ?></td>
				            <td><?php echo $d['FK_ppc2']; ?></td>
				            <td><?php echo $d['est_ppc2']; ?></td>
	 ...
	 <a href="?page=ind2&tgl=<?php echo isset($tgl) ? $tgl : ''; ?>" class="btn btn-primary">Previous Page</a>
        <?php endif; ?>
</div>
