...
<div>
	...
	<h7 class="text-center">1. Limestone R1</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">2. Limestone R2</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">3. Silicastone</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">4. Clay</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
     ...
     <h7 class="text-center">5. Iron Sand</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
	...
	<h5 class="text-center">LAPORAN BULANAN KUALITAS  PRODUK  PABRIK  INDARUNG  IV</h5>
			<h7 class="text-center">1. RAWMIX 4R1</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">2. RAWMIX 4R2</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
	...
	<h5 class="text-center">LAPORAN BULANAN KUALITAS  PRODUK  PABRIK  INDARUNG IV</h5>
			<h7 class="text-center">1. FINE COAL 4K2 & Raw Coal</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">2. FINE COAL 4K3</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
     ...
     <h7 class="text-center">3.CEMENT  MILL  4Z1 (OPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">4.CEMENT  MILL  4Z1 (PCC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">5.CEMENT  MILL  4Z1 (PCC+)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
     ...
     <h7 class="text-center">6.CEMENT  MILL  4Z2 (OPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">7.CEMENT  MILL  4Z2 (PCC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">8.CEMENT  MILL  4Z2 (PCC+)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
