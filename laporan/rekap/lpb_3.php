...
<div>
	...
	<h7 class="text-center">1. Limestone II</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">2. Limestone III<h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				while ($d = mysqli_fetch_array($q)) {
					    ...
					    <tr>
					        <td><?php echo $d['TANGGAL']; ?></td>
					        <td class="<?php echo $w_sio2ls; ?>"><?php echo $d['SiO2_ls2']; ?></td>
					        <td class="<?php echo $w_al2o3ls; ?>"><?php echo $d['Al2O3_ls2']; ?></td>
					        <td><?php echo $d['Fe2O3_ls2']; ?></td>
					        <td class="<?php echo $w_caols; ?>"><?php echo $d['CaO_ls2']; ?></td>
					        <td><?php echo $d['MgO_ls2']; ?></td>
					        <td><?php echo $d['SO3_ls2']; ?></td>
					        <td><?php echo $d['K2O_ls2']; ?></td>
					        <td><?php echo $d['Na2O_ls2']; ?></td>
					        <td><?php echo $d['Cl2_ls2']; ?></td>
					        <td class="<?php echo $w_h2ols; ?>"><?php echo $d['H2O_ls2']; ?></td>
					        <td><?php echo $d['LSF_ls2']; ?></td>
					    </tr>
					<?php
					}
					?>
	...
	<h5 class="text-center">LAPORAN BULANAN KUALITAS  PRODUK  PABRIK  INDARUNG  VI</h5>
			<h7 class="text-center">1. RAWMIX 2R1</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">2. RAWMIX 3R2</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				while ($d = mysqli_fetch_array($q)) {
					    ...
					    <tr>
					        ...
					        <td class="<?php echo $w_sdlsfr1; ?>"><?php echo $d['SDLSF_r2']; ?></td>
    ...
    <h7 class="text-center">3. KILN FEED W1</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
     ...
     <h7 class="text-center">4. KILN FEED W2</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				while ($d = mysqli_fetch_array($q)) {
					        ...
					        if ($d['ALM_kf2'] < 1.3 || $d['ALM_kf2'] > 1.9) {
					            $w_almkf = 'text-danger';
					        }$w_simkf = '';
					        if ($d['SIM_kf2'] < 2 || $d['SIM_kf2'] > 2.6) {
					            $w_simkf = 'text-danger';
					        }
					    ...
					    <tr>
					        ...
					        <td class="<?php echo $w_sdlsfkf; ?>"><?php echo $d['SDLSF_kf2']; ?></td>
					        <td><?php echo $d['SiO2_kf2']; ?></td>
					        <td><?php echo $d['Al2O3_kf2']; ?></td>
					        <td><?php echo $d['Fe2O3_kf2']; ?></td>
					        <td><?php echo $d['CaO_kf2']; ?></td>
					        <td><?php echo $d['MgO_kf2']; ?></td>
					        <td><?php echo $d['SO3_kf2']; ?></td>
					        <td><?php echo $d['K2O_kf2']; ?></td>
					        <td><?php echo $d['Na2O_kf2']; ?></td>
					        <td><?php echo $d['Cl2_kf2']; ?></td>
					    </tr>
					<?php
					}
					?>
    ...
    <h7 class="text-center">4. CLINKER W1</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">5. CLINKER W2</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
				...
				while ($d = mysqli_fetch_array($q)) {
					        ...
					        if ($d['C3A_cr2'] > 7 || $d['C3A_cr2'] < 11) {
					            $w_c3acr = 'text-danger';
					        } $w_lsfcr = '';
					        if ($d['LSF_cr2'] < 95 || $d['LSF_cr2'] > 100) {
					            $w_lsfcr = 'text-danger';
					        }$w_c3scr = '';
					        if ($d['C3S_cr2'] < 56) {
					            $w_c3scr = 'text-danger';
					    ...
					    <tr>
					        <td><?php echo $d['TANGGAL']; ?></td>
					        <td><?php echo $d['SDLSF_cr2']; ?></td>
					        <td><?php echo $d['SDC3S_cr2']; ?></td>
					        <td class="<?php echo $w_ltwcr; ?>"><?php echo $d['LTW_cr2']; ?></td>
					        <td class="<?php echo $w_flimecr; ?>"><?php echo $d['FLIME_cr2']; ?></td>
					        ...
					        <td class="<?php echo $w_c3acr; ?>"><?php echo $d['C3A_cr2']; ?></td>
					        <td><?php echo $d['FL_QAFcr2']; ?></td>
					        <td><?php echo $d['C3S_QAFcr2']; ?></td>
					        <td><?php echo $d['SiO2_cr2']; ?></td>
					        <td><?php echo $d['Al2O3_cr2']; ?></td>
					        <td><?php echo $d['Fe2O3_cr2']; ?></td>
					        <td><?php echo $d['CaO_cr2']; ?></td>
					        <td><?php echo $d['MgO_cr2']; ?></td>
					        <td><?php echo $d['SO3_cr2']; ?></td>
					        <td><?php echo $d['K2O_cr2']; ?></td>
					        <td><?php echo $d['Na2O_cr2']; ?></td>
					        <td><?php echo $d['Cl2_cr2']; ?></td>
					    </tr>
					<?php
					}
					?>
	...
	<h5 class="text-center">LAPORAN BULANAN KUALITAS  PRODUK  PABRIK  INDARUNG  VI</h5>
			<h7 class="text-center">1. FINE COAL 2K1 & Raw Coal </h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">2. FINE COAL 3K2</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>

					<tr class="text-center" >
			           <th colspan="1"></th><th colspan="4">Fine Coal</th>
			        </tr>

					<tr class="bg-primary text-white">
						
						<th>TANGGAL</th> <th>90u</th> <th>H2O</th><th>ASH</th> <th>SD ASH</th>
					</tr>
				</thead>
				...
				while ($d = mysqli_fetch_array($q)) {
					    ...
					    <tr>
					        ...
					        <td class="<?php echo $w_fch2o; ?>"><?php echo $d['fcH2O_fc2']; ?></td>
					        <td class="<?php echo $w_ashfc; ?>"><?php echo $d['ASH_fc2']; ?></td>
					        <td><?php echo $d['SDASH_fc2']; ?></td>
					<?php
					}
					?>
					
    </table>
     <h7 class="text-center">3.CEMENT  MILL  2Z1 (OPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
         ...
         <h7 class="text-center">4.CEMENT  MILL  3Z2 (OPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">5.CEMENT  MILL  2Z1 (PCC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
     ...
     <h7 class="text-center">6.CEMENT  MILL  3Z2 (PCC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">7.CEMENT  MILL  2Z1 (PPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
     ...
     <h7 class="text-center">8.CEMENT  MILL  3Z2 (PPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
