		...
		<table class="adminlist mb-3" border="1" width="500" cellpadding="5">
			<thead>
				<tr class="text-center" >
			            <th rowspan="2"></th> <th colspan="2">LS STG</th><th  colspan="3">5R1</th><th  colspan="3">5R2</th><th colspan="3">KF</th><th colspan="6">CR</th><th colspan="2">F.CoaL 4K2</th><th colspan="2">F.CoaL 4K3</th><th colspan="1">CF</th><th colspan="1">RC</th>
			        </tr>
			    <tr bgcolor="#8080FF" style="color:#FFFFFF">
			        <th>SiO2</th><th>CaO</th><th>LSF</th><th>SIM</th><th>ALM</th><th>LSF</th><th>SIM</th><th>ALM</th><th>LSF</th><th>SIM</th><th>ALM</th><th>FCaO</th><th>LSF</th><th>SIM</th><th>ALM</th><th>C3S</th><th>C3A</th><th>H2O</th><th>ASH</th><th>H2O</th><th>ASH</th><th>SILO</th><th>H2O</th>
			    </tr> 
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			     ...
			     <tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    if (isset($_GET['tgl'])) {
					    ...
					    $kolom = array("sio2lstg", "cao", "lsfr1", "simr1", "almr1",  "lsfr2", "simr2", "almr2", "lsfkf", "simkf", "almkf", "fcaocr","lsfcr", "simcr", "almcr", "c3scr","c3acr", "h2ofc", "ashfc",  "h2ofc2", "ashfc2");
			    ...
			    <?php
			        ...
			        $datain_query = mysqli_query($conn, "SELECT 
			            ...
			            COUNT(IF(fcH2O_fc2 > 20 , 1, NULL)) AS datain_h2ofc2,
			            COUNT(IF(ASH_fc2 > 20 , 1, NULL)) AS datain_ashfc2
			        ...
			        foreach ($kolom as $nama_kolom) {
			            ...
			            $datain_h2ofc2 = isset($datain_result["datain_h2ofc2"]) ? $datain_result["datain_h2ofc2"] : 0;
			            $datain_ashfc2 = isset($datain_result["datain_ashfc2"]) ? $datain_result["datain_ashfc2"] : 0;
				        ...
				        }  elseif ($nama_kolom == "h2ofc2") {
				            $hasil = $count - $datain_h2ofc2 ;
				        } elseif ($nama_kolom == "ashfc2") {
				            $hasil = $count - $datain_ashfc2 ;
				        }
				       if ($count > 0 || $hasil > 0) {
