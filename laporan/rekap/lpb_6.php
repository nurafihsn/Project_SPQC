...
<div>
	...
	<h5 class="text-center">LAPORAN BULANAN KUALITAS  PRODUK  PABRIK  INDARUNG  VI</h5>
			<h7 class="text-center">1. RAWMIX 6R1</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">2. KILN FEED</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">3. CLINKER</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
	...
	<h5 class="text-center">LAPORAN BULANAN KUALITAS  PRODUK  PABRIK  INDARUNG  VI</h5>
     ...
     <h7 class="text-center">2.CEMENT  MILL  6Z1 (OPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">3.CEMENT  MILL  6Z1 (PCC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
    ...
    <h7 class="text-center">4.CEMENT  MILL  6Z1 (PPC)</h7>
			 <table class="table table-striped table-bordered table-hover" >
				<thead>
