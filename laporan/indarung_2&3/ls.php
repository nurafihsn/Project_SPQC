...
<body>
    ...
    if ($id_e) {
        ...
        $sql = "UPDATE ls_3 SET $setClause WHERE id = ?";
...
if (isset($_GET['awal']) && isset($_GET['akhir'])) {
    $awal = $_GET['awal'];
    $akhir = $_GET['akhir'];
    $sql_filtered = "SELECT * FROM ls_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
} elseif (isset($_GET['kemarin'])) {
    $sql_filtered = "SELECT * FROM ls_3 WHERE TANGGAL = CURDATE() - INTERVAL 1 DAY";
}
else {
    $sql_filtered = "SELECT * FROM ls_3 WHERE TANGGAL = CURDATE()";
}
...
?>
		...
		<center style="font-family: Arial, sans-serif; font-size: 24px; font-weight: bold; color: #333333; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);">
		    <label>LIMESTONE Indarung 2&3</label>
		</center>
	...
	<table class="adminlist mb-3" border="1" width="500" cellpadding="5" >
			    ...
			    <tr bgcolor="#8080FF" style="color:#FFFFFF">
			     ...
			     <tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    if(isset($_GET['awal']) && isset($_GET['akhir'])){
				      ...
				      $count_query = mysqli_query($conn, "SELECT COUNT(LSFr1) AS count_lsfr1, COUNT(SIMr1) AS count_simr1, COUNT(ALMr1) AS count_almr1, COUNT(SiO2r1) AS count_sio2r1, COUNT(Al2O3r1) AS count_al2o3r1, COUNT(Fe2O3r1) AS count_Fe2O3r1, COUNT(CaOr1) AS count_caor1, COUNT(MgOr1) AS count_MgOr1, COUNT(SO3r1) AS count_SO3r1, COUNT(K2Or1) AS count_K2Or1, COUNT(Na2Or1) AS count_Na2Or1, COUNT(SUMr1) AS count_sumr1, COUNT(H2Or1) AS count_H2Or1, COUNT(LSFr2) AS count_lsfr2, COUNT(SIMr2) AS count_simr2, COUNT(ALMr2) AS count_almr2, COUNT(SiO2r2) AS count_sio2r2, COUNT(Al2O3r2) AS count_al2o3r2, COUNT(Fe2O3r2) AS count_Fe2O3r2, COUNT(CaOr2) AS count_caor2, COUNT(MgOr2) AS count_MgOr2, COUNT(SO3r2) AS count_SO3r2, COUNT(K2Or2) AS count_K2Or2, COUNT(Na2Or2) AS count_Na2Or2, COUNT(SUMr2) AS count_sumr2, COUNT(H2Or2) AS count_H2Or2 FROM ls_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
				        ...
				        $sql = mysqli_query($conn,"SELECT * FROM ls_3");
			      ...
			      <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			       $min_query = mysqli_query($conn, "SELECT MIN(LSFr1) AS min_lsfr1, MIN(SIMr1) AS min_simr1, MIN(ALMr1) AS min_almr1, MIN(SiO2r1) AS min_SiO2r1, MIN(Al2O3r1) AS min_Al2O3r1, MIN(Fe2O3r1) AS min_Fe2O3r1, MIN(CaOr1) AS min_CaOr1, MIN(MgOr1) AS min_MgOr1, MIN(SO3r1) AS min_SO3r1, MIN(K2Or1) AS min_K2Or1, MIN(Na2Or1) AS min_Na2Or1, MIN(SUMr1) AS min_sumr1, MIN(H2Or1) AS min_H2Or1, MIN(LSFr2) AS min_lsfr2, MIN(SIMr2) AS min_simr2, MIN(ALMr2) AS min_almr2, MIN(SiO2r2) AS min_SiO2r2, MIN(Al2O3r2) AS min_Al2O3r2, MIN(Fe2O3r2) AS min_Fe2O3r2, MIN(CaOr2) AS min_CaOr2, MIN(MgOr2) AS min_MgOr2, MIN(SO3r2) AS min_SO3r2, MIN(K2Or2) AS min_K2Or2, MIN(Na2Or2) AS min_Na2Or2, MIN(SUMr2) AS min_sumr2, MIN(H2Or2) AS min_H2Or2 FROM ls_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			     $average_query = mysqli_query($conn, "SELECT AVG(LSFr1) AS avg_lsfr1, AVG(SIMr1) AS avg_simr1, AVG(ALMr1) AS avg_almr1, AVG(SiO2r1) AS avg_SiO2r1, AVG(Al2O3r1) AS avg_Al2O3r1, AVG(Fe2O3r1) AS avg_Fe2O3r1, AVG(CaOr1) AS avg_CaOr1, AVG(MgOr1) AS avg_MgOr1, AVG(SO3r1) AS avg_SO3r1, AVG(K2Or1) AS avg_K2Or1, AVG(Na2Or1) AS avg_Na2Or1,  AVG(SUMr1) AS avg_sumr1, AVG(H2Or1) AS avg_H2Or1, AVG(LSFr2) AS avg_lsfr2, AVG(SIMr2) AS avg_simr2, AVG(ALMr2) AS avg_almr2, AVG(SiO2r2) AS avg_SiO2r2, AVG(Al2O3r2) AS avg_Al2O3r2, AVG(Fe2O3r2) AS avg_Fe2O3r2, AVG(CaOr2) AS avg_CaOr2, AVG(MgOr2) AS avg_MgOr2, AVG(SO3r2) AS avg_SO3r2, AVG(K2Or2) AS avg_K2Or2, AVG(Na2Or2) AS avg_Na2Or2, AVG(SUMr2) AS avg_sumr2,  AVG(H2Or2) AS avg_H2Or2 FROM ls_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			        $max_query = mysqli_query($conn, "SELECT MAX(LSFr1) AS max_lsfr1, MAX(SIMr1) AS max_simr1, MAX(ALMr1) AS max_almr1, MAX(SiO2r1) AS max_SiO2r1, MAX(Al2O3r1) AS max_Al2O3r1, MAX(Fe2O3r1) AS max_Fe2O3r1, MAX(CaOr1) AS max_CaOr1, MAX(MgOr1) AS max_MgOr1, MAX(SO3r1) AS max_SO3r1, MAX(K2Or1) AS max_K2Or1, MAX(Na2Or1) AS max_Na2Or1,  MAX(SUMr1) AS max_sumr1,  MAX(H2Or1) AS max_H2Or1, MAX(LSFr2) AS max_lsfr2, MAX(SIMr2) AS max_simr2, MAX(ALMr2) AS max_almr2, MAX(SiO2r2) AS max_SiO2r2, MAX(Al2O3r2) AS max_Al2O3r2, MAX(Fe2O3r2) AS max_Fe2O3r2, MAX(CaOr2) AS max_CaOr2, MAX(MgOr2) AS max_MgOr2, MAX(SO3r2) AS max_SO3r2, MAX(K2Or2) AS max_K2Or2, MAX(Na2Or2) AS max_Na2Or2, MAX(SUMr2) AS max_sumr2, MAX(H2Or2) AS max_H2Or2 FROM ls_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			       $sd_query = mysqli_query($conn, "SELECT STDDEV(LSFr1) AS sd_lsfr1, STDDEV(SIMr1) AS sd_simr1, STDDEV(ALMr1) AS sd_almr1, STDDEV(SiO2r1) AS sd_SiO2r1, STDDEV(Al2O3r1) AS sd_Al2O3r1, STDDEV(Fe2O3r1) AS sd_Fe2O3r1, STDDEV(CaOr1) AS sd_CaOr1, STDDEV(MgOr1) AS sd_MgOr1, STDDEV(SO3r1) AS sd_SO3r1, STDDEV(K2Or1) AS sd_K2Or1, STDDEV(Na2Or1) AS sd_Na2Or1, STDDEV(SUMr1) AS sd_sumr1, STDDEV(H2Or1) AS sd_H2Or1, STDDEV(LSFr2) AS sd_lsfr2, STDDEV(SIMr2) AS sd_simr2, STDDEV(ALMr2) AS sd_almr2, STDDEV(SiO2r2) AS sd_SiO2r2, STDDEV(Al2O3r2) AS sd_Al2O3r2, STDDEV(Fe2O3r2) AS sd_Fe2O3r2, STDDEV(CaOr2) AS sd_CaOr2, STDDEV(MgOr2) AS sd_MgOr2, STDDEV(SO3r2) AS sd_SO3r2, STDDEV(K2Or2) AS sd_K2Or2, STDDEV(Na2Or2) AS sd_Na2Or2, STDDEV(SUMr2) AS sd_sumr2, STDDEV(H2Or2) AS sd_H2Or2 FROM ls_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
					...
					if (isset($_GET['awal']) && isset($_GET['akhir'])) {
					    ...
					    $datain_query = mysqli_query($conn, "SELECT 
					        ...
					        FROM ls_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
		...
		<div>
			 <table class="table table-striped table-bordered table-hover m">
				<thead>
					...
					<tr class="text-center" >
			            <th colspan="1"></th><th colspan="16">LS R1</th><th colspan="16">LS R2</th>
			        </tr>
					<tr class="text-center" >
			             <th  colspan="1" ></th><th colspan="3">LIMESTONE</th><th colspan="8">OKSIDA</th> <th colspan="4"></th> <th colspan="1"></th><th colspan="3">LIMESTONE</th><th colspan="8">OKSIDA</th> <th colspan="4"></th> <th colspan="1"></th><th colspan="3"></th>
			        </tr>

					<tr class="bg-primary text-white">
						
						<th>Tanggal</th><th>LSF</th> <th>SIM</th> <th>ALM</th><th>SiO2</th> <th>Al2O3</th> <th>Fe2O3</th> <th>CaO</th> <th>MgO</th> <th>SO3</th> <th>K2O</th> <th>Na2O</th><th>SUM</th><th>H2O</th> <th>PILE</th> <th>TIANG</th><th>JAM SAMPLING</th><th>LSF</th> <th>SIM</th> <th>ALM</th><th>SiO2</th> <th>Al2O3</th> <th>Fe2O3</th> <th>CaO</th> <th>MgO</th> <th>SO3</th> <th>K2O</th> <th>Na2O</th> <th>SUM</th><th>H2O</th> <th>PILE</th> <th>TIANG</th><th>JAM SAMPLING</th><th>KETERANGAN</th> <th>Report</th>
				...
				<tbody>
					  <?php
					    ...
					    while ($d = mysqli_fetch_array($q)) {
					       ...
					       $update_query = "UPDATE ls_3 SET LSFr1=?, SIMr1=?, ALMr1=?, SUMr1=?, ALKALIr1=?, LSFr2=?, SIMr2=?, ALMr2=?, SUMr2=?, ALKALIr2=? WHERE id=?";
					            ...
					            <div class="modal-dialog">
									...
									<div class="modal-body">
										<form role="form" action="" method="get">
											...
											<?php
											$id = $d['id'];
											$sql = "SELECT * FROM ls_3 where id ='$id' ";
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					if (isset($_POST['submit'])) {
					    ...
					    $sql = "INSERT INTO ls_3 (TANGGAL, SiO2r1, Al2O3r1, Fe2O3r1, CaOr1, MgOr1, SO3r1, K2Or1, Na2Or1, H2Or1, PILEr1, TIANGr1, JAMr1,SiO2r2, Al2O3r2, Fe2O3r2, CaOr2, MgOr2, SO3r2, K2Or2, Na2Or2, H2Or2, PILEr2, TIANGr2, JAMr2, waktu, iduser) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";
					    $stmt = mysqli_prepare($conn, $sql);
					    mysqli_stmt_bind_param($stmt, "sssssssssssssssssssssssssss", $tanggal, $SiO2r1, $Al2O3r1, $Fe2O3r1, $CaOr1, $MgOr1, $SO3r1, $K2Or1, $Na2Or1, $H2Or1, $PILEr1, $TIANGr1, $JAMr1,$SiO2r2, $Al2O3r2, $Fe2O3r2, $CaOr2, $MgOr2, $SO3r2, $K2Or2, $Na2Or2, $H2Or2, $PILEr2, $TIANGr2, $JAMr2, $waktu, $username);
					...
					$sql = "SELECT * FROM ls_3 ORDER BY TANGGAL DESC";
					$q = mysqli_query($conn, $sql);
					?>
					...
					<div class="container">
						<form method="POST" onsubmit="return validateForm()">
							...
							<div class="form-group row my-0">
							    <label for="TIANGr1" class="col-sm-4 col-form-label">TIANG</label>
							    <div class="col-sm-8">
							        <input type="text" style="height:30px" class="form-control" id="TIANGr1" name="TIANGr1" placeholder="Enter TIANG" >
							    </div>
							</div>
							<div class="form-group row my-0">
							    <label for="JAMr1" class="col-sm-4 col-form-label">JAM SAMPLING</label>
							    <div class="col-sm-8">
							        <input type="text" style="height:30px" class="form-control" id="JAMr1" name="JAMr1" placeholder="Enter JAM SAMPLING" >
							    </div>
							</div>
							<br>
								<center>LS R2</center>
							...
							<div class="form-group row my-0">
							    <label for="TIANGr2" class="col-sm-4 col-form-label">TIANG</label>
							    <div class="col-sm-8">
							        <input type="text" style="height:30px" class="form-control" id="TIANGr2" name="TIANGr2" placeholder="Enter TIANG" >
							    </div>
							</div>
							<div class="form-group row my-0">
							    <label for="JAMr2" class="col-sm-4 col-form-label">JAM SAMPLING</label>
							    <div class="col-sm-8">
							        <input type="text" style="height:30px" class="form-control" id="JAMr2" name="JAMr2" placeholder="Enter JAM SAMPLING" >
							    </div>
							</div>
	...
	<script>
	    function validateForm() {
	        ...
	        var inputs = [SiO2r1, Al2O3r1, Fe2O3r1, CaOr1, MgOr1, SO3r1, K2Or1, Na2Or1, H2Or1, SiO2r2, Al2O3r2, Fe2O3r2, CaOr2, MgOr2, SO3r2, K2Or2, Na2Or2, H2Or2];
