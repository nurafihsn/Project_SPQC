...
<body>
	...
	if (isset($_REQUEST['update'])) {
		...
		$sql = "UPDATE cr1_3 SET JAM=?, LTW=?, TEMP=?, WARNA=?, FISIK=?, SILO=?, TYPE=?, BERAT_sampel=?, LOLOS_ayakan=?, SiO2=?, Al2O3=?, Fe2O3=?, CaO=?, MgO=?, SO3=?, K2O=?, Na2O=?, FCaO=? WHERE id=?";
...
if (isset($_GET['awal']) && isset($_GET['akhir'])) {
    ...
    $sql_filtered = "SELECT * FROM cr1_3 WHERE TANGGAL = CURDATE() - INTERVAL 1 DAY";
}
else {
    $sql_filtered = "SELECT * FROM cr1_3 WHERE TANGGAL = CURDATE()";
}
	            ...
	            <div class="modal-body">
	               <?php
	                    ...
	                    if (isset($_POST['submit'])) {
	                        ...
	                        $sql = "INSERT INTO cr1_3 (TANGGAL, JAM, LTW, TEMP, SiO2, Al2O3, Fe2O3, CaO, MgO, SO3, K2O, Na2O, FCaO, WARNA, FISIK, SILO,TYPE , BERAT_sampel, LOLOS_ayakan, waktu, iduser) 
        						VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
					    $stmt = mysqli_prepare($conn, $sql);
