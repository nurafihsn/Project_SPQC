        ...
        <table class="table table-striped table-bordered table-hover" id="crf">
            <thead>
                    <tr class="text-center" >
                        <th  rowspan="1" ></th><th  rowspan="1" ></th><th colspan="5">CR FEEDER Z1</th><th colspan="11">OKSIDA</th> <th colspan="1"></th><th colspan="1"></th></th><th colspan="5">CR FEEDER Z2</th><th colspan="11">OKSIDA</th> <th colspan="1"></th><th colspan="2"></th>
                    </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM crf_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
            ...
            while ($d = mysqli_fetch_array($q)) {
                ...
                <tr>   
                                ...
                                <td><?php echo $d['LSF_z1']; ?></td>
                                <td><?php echo $d['SIM_z1']; ?></td>
                                <td><?php echo $d['ALM_z1']; ?></td>
                                <td><?php echo $d['C3S_z1']; ?></td>
                                <td><?php echo $d['C3A_z1']; ?></td>
                                ...
                                <td><?php echo $d['Cl2_z1']; ?></td>
                                <td><?php echo $d['FCaO_z1']; ?></td>
                                <td><?php echo $d['SUM_z1']; ?></td>
                                <td><?php echo $d['ALKALI_z1']; ?></td>
                                <td><?php echo $d['KETERANGAN_z1']; ?></td>
                                <td><?php echo $d['LSF_z2']; ?></td>
                                <td><?php echo $d['SIM_z2']; ?></td>
                                <td><?php echo $d['ALM_z2']; ?></td>
                                <td><?php echo $d['C3S_z2']; ?></td>
                                <td><?php echo $d['C3A_z2']; ?></td>
                                ...
                                <td><?php echo $d['Cl2_z2']; ?></td>
                                <td><?php echo $d['FCaO_z2']; ?></td>
                                <td><?php echo $d['SUM_z2']; ?></td>
                                <td><?php echo $d['ALKALI_z2']; ?></td>
