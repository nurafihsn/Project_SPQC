...
<body>
<div class="container">
    <h2>STORAGE LS Si TINGGI INDARUNG 2&3</h2>
        ...
        <table class="table table-striped table-bordered table-hover" id="ss">
            <thead>
                    <tr class="text-center" >
                         </th><th  rowspan="1" ></th><th colspan="3">LS Si Tinggi</th><th colspan="8">OKSIDA</th> <th colspan="1"></th><th colspan="2"></th>
                    </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM lststg_3 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
