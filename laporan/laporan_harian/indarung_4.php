...
<body>
	<h3 class="text-center mb-5">PABRIK INDARUNG IV</h3>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
                            $sql = "SELECT * FROM r1_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
                        } elseif(isset($_GET['tgl'])){
                            $tgl = $_GET['tgl'];
                            $tgl = mysqli_real_escape_string($conn, $tgl);
                            $sql = "SELECT * FROM r1_4 WHERE TANGGAL = '$tgl'";
            ...
            <div class="col-md-6">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                        if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
                            $sql = "SELECT * FROM r2_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
                        } elseif(isset($_GET['tgl'])){
                            $tgl = $_GET['tgl'];
                            $tgl = mysqli_real_escape_string($conn, $tgl);
                            $sql = "SELECT * FROM r2_4 WHERE TANGGAL = '$tgl'";
                        } elseif (isset($_GET['opentoday'])) {
       ...
       <h6 class="text-center">KILN FEED</h6>
        <div class="row">
            <div class="col-md-7">
				...
				<?php
				if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
				    $sql = "SELECT * FROM kf_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
				} elseif(isset($_GET['tgl'])){
				    $tgl = $_GET['tgl'];
				    $tgl = mysqli_real_escape_string($conn, $tgl);
				    $sql = "SELECT * FROM kf_4 WHERE TANGGAL = '$tgl'";
				} elseif (isset($_GET['opentoday'])) {
				    $sql = "SELECT * FROM kf_4 WHERE TANGGAL = CURDATE()";
				} else {
				    $sql = "SELECT * FROM kf_4 WHERE TANGGAL = CURDATE()";
				}
    ...
    <div class="col-md-1">
				...
				<?php
				if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
				    $sql = "SELECT * FROM ep_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
				} elseif(isset($_GET['tgl'])){
				    $tgl = $_GET['tgl'];
				    $tgl = mysqli_real_escape_string($conn, $tgl);
				    $sql = "SELECT * FROM ep_4 WHERE TANGGAL = '$tgl'";
				} elseif (isset($_GET['opentoday'])) {
	...
	<h6 class="text-center">CLINKER</h6>
       <div class="row">
            <div class="col-md-7">
				...
				<?php
				if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
				    $sql = "SELECT * FROM cr_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
				} elseif(isset($_GET['tgl'])){
				    $tgl = $_GET['tgl'];
				    $tgl = mysqli_real_escape_string($conn, $tgl);
				    $sql = "SELECT * FROM cr_4 WHERE TANGGAL = '$tgl'";
				} elseif (isset($_GET['opentoday'])) {
				...
				<div class="col-md-1">
                <table class="table table-striped table-bordered table-hover" style="width: 40% ; margin-left: 100px" >
				<thead>
					<tr class="text-center" >
			         </th><th colspan="1" style="width: 20%"> RAWCOAL</th> <th colspan="3">FINECOAL 4K2</th> <th colspan="3">FINECOAL 4K3</th>

					<tr class="bg-primary text-white text-center">
						
						<th>H2O</th> <th>90u</th><th>H2O </th> <th>ASH</th><th>90u</th><th>H2O </th> <th>ASH</th>
					</tr>
				</thead>
				<?php
				if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
				    $sql = "SELECT * FROM fc_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
				} elseif(isset($_GET['tgl'])){
				    $tgl = $_GET['tgl'];
				    $tgl = mysqli_real_escape_string($conn, $tgl);
				    $sql = "SELECT * FROM fc_4 WHERE TANGGAL = '$tgl'";
				} elseif (isset($_GET['opentoday'])) {
...
<h6 class="text-center">CEMENT</h6>
        <div class="row">
            <div class="col-md-6">
				...
				<?php
				if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
				    $sql = "SELECT * FROM z1_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
				} elseif(isset($_GET['tgl'])){
				    $tgl = $_GET['tgl'];
				    $tgl = mysqli_real_escape_string($conn, $tgl);
				    $sql = "SELECT * FROM z1_4 WHERE TANGGAL = '$tgl'";
				} elseif (isset($_GET['opentoday'])) {
			 ...
			 <div class="col-md-6">
				...
				<?php
				if(isset($_GET['data2jam']) && $_GET['data2jam'] == '1'){
				    $sql = "SELECT * FROM z2_4 WHERE TANGGAL = CURDATE() AND waktu >= NOW() - INTERVAL 3 HOUR";
				} elseif(isset($_GET['tgl'])){
				    $tgl = $_GET['tgl'];
				    $tgl = mysqli_real_escape_string($conn, $tgl);
				    $sql = "SELECT * FROM z2_4 WHERE TANGGAL = '$tgl'";
				} elseif (isset($_GET['opentoday'])) {
