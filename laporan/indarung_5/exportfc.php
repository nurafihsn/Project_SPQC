...
<body>
<div class="container">
    <h2>FINE COAL & RAW COAL Indarung 5</h2>
        ...
        <table class="table table-striped table-bordered table-hover" id="fc">
            <thead>
                ...
                <tr class="bg-primary text-white">
                    <th>Tanggal</th><th>Jam</th><th>90u</th><th>H2O</th><th>ASH</th> <th>ADB</th> <th>SHIFT</th> <th>H2O</th> <th>Report</th>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM fc_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
            ...
            while ($d = mysqli_fetch_array($q)) {
                ...
                <tr>   
                   ...
                   <td><?php echo $d['fc90u']; ?></td>
                   <td><?php echo $d['H2O_fc']; ?></td>
                   <td><?php echo $d['ASH']; ?></td>
                   <td><?php echo $d['ADB']; ?></td>
