...
<body>
    ...
    $kf90u_e = isset($_GET['kf90u_e']) && $_GET['kf90u_e'] !== '' ? $_GET['kf90u_e'] : NULL;
    $kf180u_e = isset($_GET['kf180u_e']) && $_GET['kf180u_e'] !== '' ? $_GET['kf180u_e'] : NULL;
    ...
    $arah_BHF_e = isset($_GET['arah_BHF_e']) && $_GET['arah_BHF_e'] !== '' ? $_GET['arah_BHF_e'] : NULL;
    $LEVEL_cf_e = isset($_GET['LEVEL_cf_e']) && $_GET['LEVEL_cf_e'] !== '' ? $_GET['LEVEL_cf_e'] : NULL;
    $FEED_kiln_e = isset($_GET['FEED_kiln_e']) && $_GET['FEED_kiln_e'] !== '' ? $_GET['FEED_kiln_e'] : NULL;
    $FEED_fc_e = isset($_GET['FEED_fc_e']) && $_GET['FEED_fc_e'] !== '' ? $_GET['FEED_fc_e'] : NULL;
    $id_e = isset($_GET['id_e']) && $_GET['id_e'] !== '' ? $_GET['id_e'] : NULL;

    $sql = "UPDATE kf_5 SET JAM=?, kf90u=?, kf180u=?, H2O=?, SiO2=?, Al2O3=?, Fe2O3=?, CaO=?, MgO=?, SO3=?, K2O=?, Na2O=?, Cl2=?, arah_BHF=?, LEVEL_cf=?, FEED_kiln=?, FEED_fc=? WHERE id=?";
    ...
    mysqli_stmt_bind_param($stmt, "sssssssssssssssssi", $JAM_e, $kf90u_e, $kf180u_e, $H2O_e, $SiO2_e, $Al2O3_e, $Fe2O3_e, $CaO_e, $MgO_e, $SO3_e, $K2O_e, $Na2O_e, $Cl2_e, $arah_BHF_e, $LEVEL_cf_e, $FEED_kiln_e, $FEED_fc_e, $id_e);

    if (mysqli_stmt_execute($stmt)) {
        echo "<script>window.location = 'kf.php'</script>";
    } 
...
if (isset($_GET['awal']) && isset($_GET['akhir'])) {
    $awal = $_GET['awal'];
    $akhir = $_GET['akhir'];
    $sql_filtered = "SELECT * FROM kf_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
} elseif (isset($_GET['kemarin'])) {
    $sql_filtered = "SELECT * FROM kf_5 WHERE TANGGAL = CURDATE() - INTERVAL 1 DAY";
}
else {
    $sql_filtered = "SELECT * FROM kf_5 WHERE TANGGAL = CURDATE() ";
}
...
?>
		...
		<center style="font-family: Arial, sans-serif; font-size: 24px; font-weight: bold; color: #333333; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.3);">
		    <label>KILN FEED Indarung 5</label>
		</center>
	...
	<table class="adminlist mb-3" border="1" width="500" cellpadding="5" >
			    <tr bgcolor="#8080FF" style="color:#FFFFFF">
			     ...
			     <tr bgcolor="YELLOW" style="color:BLACK">
				    ...
				    if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
				       $count_query = mysqli_query($conn, "SELECT COUNT(LSF) AS count_lsf, COUNT(SIM) AS count_sim, COUNT(ALM) AS count_alm, COUNT(kf90u) AS count_kf90u, COUNT(kf180u) AS count_kf180u, COUNT(H2O) AS count_h2o, COUNT(SiO2) AS count_sio2, COUNT(Al2O3) AS count_al2o3, COUNT(Fe2O3) AS count_fe2o3, COUNT(CaO) AS count_cao, COUNT(MgO) AS count_mgo, COUNT(SO3) AS count_so3, COUNT(K2O) AS count_k2o, COUNT(Na2O) AS count_na2o, COUNT(Cl2) AS count_cl2, COUNT(SUM) AS count_sum, COUNT(ALKALI) AS count_alkali FROM kf_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
				        ...
				        $sql = mysqli_query($conn,"SELECT * FROM kf_5");
			      ...
			      <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			      $min_query = mysqli_query($conn, "SELECT MIN(LSF) AS min_lsf, MIN(SIM) AS min_sim, MIN(ALM) AS min_alm, MIN(kf90u) AS min_kf90u, MIN(kf180u) AS min_kf180u, MIN(H2O) AS min_h2o, MIN(SiO2) AS min_sio2, MIN(Al2O3) AS min_al2o3, MIN(Fe2O3) AS min_fe2o3, MIN(CaO) AS min_cao, MIN(MgO) AS min_mgo, MIN(SO3) AS min_so3, MIN(K2O) AS min_k2o, MIN(Na2O) AS min_na2o, MIN(Cl2) AS min_cl2, MIN(SUM) AS min_sum, MIN(ALKALI) AS min_alkali FROM kf_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			       $average_query = mysqli_query($conn, "SELECT AVG(LSF) AS avg_lsf, AVG(SIM) AS avg_sim, AVG(ALM) AS avg_alm, AVG(kf90u) AS avg_kf90u, AVG(kf180u) AS avg_kf180u, AVG(H2O) AS avg_h2o, AVG(SiO2) AS avg_sio2, AVG(Al2O3) AS avg_al2o3, AVG(Fe2O3) AS avg_fe2o3, AVG(CaO) AS avg_cao, AVG(MgO) AS avg_mgo, AVG(SO3) AS avg_so3, AVG(K2O) AS avg_k2o, AVG(Na2O) AS avg_na2o, AVG(Cl2) AS avg_cl2, AVG(SUM) AS avg_sum, AVG(ALKALI) AS avg_alkali FROM kf_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			        $max_query = mysqli_query($conn, "SELECT MAX(LSF) AS max_lsf, MAX(SIM) AS max_sim, MAX(ALM) AS max_alm,MAX(kf90u) as max_kf90u,MAX(kf180u) as max_kf180u, MAX(H2O) AS max_h2o, MAX(SiO2) AS max_sio2, MAX(Al2O3) AS max_al2o3, MAX(Fe2O3) AS max_fe2o3, MAX(CaO) AS max_cao, MAX(MgO) AS max_mgo, MAX(SO3) AS max_so3, MAX(K2O) AS max_k2o, MAX(Na2O) AS max_na2o, MAX(Cl2) AS max_cl2, MAX(SUM) AS max_sum, MAX(ALKALI) AS max_alkali FROM kf_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
			    ...
			    <tr bgcolor="YELLOW" style="color:BLACK">
			        ...
			        if(isset($_GET['awal']) && isset($_GET['akhir'])){
				        $awal = $_GET['awal'];
			        	$akhir = $_GET['akhir'];
			      $sd_query = mysqli_query($conn, "SELECT STDDEV(LSF) AS sd_lsf, STDDEV(SIM) AS sd_sim, STDDEV(ALM) AS sd_alm, STDDEV(kf90u) AS sd_kf90u, STDDEV(kf180u) AS sd_kf180u, STDDEV(H2O) AS sd_h2o, STDDEV(SiO2) AS sd_sio2, STDDEV(Al2O3) AS sd_al2o3, STDDEV(Fe2O3) AS sd_fe2o3, STDDEV(CaO) AS sd_cao, STDDEV(MgO) AS sd_mgo, STDDEV(SO3) AS sd_so3, STDDEV(K2O) AS sd_k2o, STDDEV(Na2O) AS sd_na2o, STDDEV(Cl2) AS sd_cl2, STDDEV(SUM) AS sd_sum, STDDEV(ALKALI) AS sd_alkali FROM kf_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'");
	...
	<div class="container">
	    <div class="row">
	        <div class="col-sm-3">
	            ...
	            <div class="form-group">
	                <a href="exportkf.php" class="btn btn-primary" > Download </a>
	            </div>
	        </div>        
	    </div>
	</div>
			 ...
			 <table class="table table-striped table-bordered table-hover m">
				<thead>
					...
					<tr class="text-center" >
			             <th  rowspan="1" ></th><th  rowspan="1" ></th><th colspan="7">KILN FEED</th><th colspan="11">OKSIDA</th> <th colspan="5"></th>
			        </tr>

					<tr class="bg-primary text-white">
						
						<th>Tanggal</th><th>Jam</th><th>LSF</th> <th>SIM</th> <th>ALM</th><th>BF</th><th>90u</th><th>180u</th> <th>H2O</th><th>SiO2</th> <th>Al2O3</th> <th>Fe2O3</th> <th>CaO</th> <th>MgO</th> <th>SO3</th> <th>K2O</th> <th>Na2O</th> <th>Cl2</th><th>SUM</th><th>Alkali</th><th>ARAH BHF</th> <th>LEVEL CF SILO</th> <th>FEED KILN</th> <th>FEED FC</th><th>TON EMISI CO2</th><th>Report</th>
				...
				<tbody>
					    ...
					    while ($d = mysqli_fetch_array($q)) {
					        ...
					        $bf = null;
							if (!empty($d['SiO2'])) {
							    $bf = $lsf + 10 * $sim - 3 * ($d['MgO'] + 0.2);
							}
							$bf = !is_null($bf) ? number_format((float)$bf, 2, '.', '') : null;

							$ton_emisi = NULL;
							if (!empty($d['FEED_fc'])) {
							    $ton_emisi = (($d['CaO'] * 0.786 + $d['MgO'] * 1.1) / 100 * $d['FEED_kiln']) + (1.815 * $d['FEED_fc']);
							}
							$ton_emisi = !is_null($ton_emisi) ? number_format((float)$ton_emisi, 2, '.', '') : NULL;



					        $update_query = "UPDATE kf_5 SET LSF=?, SIM=?, ALM=?, SUM=?, ALKALI=?, BF=?, TON_emisi=? WHERE id=?";
							$stmt = mysqli_prepare($conn, $update_query);

							mysqli_stmt_bind_param($stmt, "ssssssid", $lsf, $sim, $alm, $sum, $alkali, $bf, $ton_emisi, $d['id']);
					        ...
					        $w_180u = '';
					        if ($d['kf180u'] > $configs['kf180u5']['max'] ) {
					            $w_180u = 'text-danger';
					        }
					        $w_90u = '';
							if ($d['kf90u'] > $configs['kf90u5']['max'] ) {
							    $w_90u = 'text-danger';
							}
							$w_h2o = '';
							if ($d['H2O'] < $configs['H2Okf5']['min'] || $d['H2O'] > $configs['H2Okf5']['max']) {
							    $w_h2o = 'text-danger';
							}
							$w_alm = '';
							if ($alm < $configs['ALMkf5']['min'] || $alm > $configs['ALMkf5']['max']) {
							    $w_alm = 'text-danger';
							}
					        $w_sim = '';
							if ($sim < $configs['SIMkf5']['min'] || $sim > $configs['SIMkf5']['max']) {
							    $w_sim = 'text-danger';
							}
							$w_lsf = '';
							if ($lsf < $configs['LSFkf5']['min'] || $lsf > $configs['LSFkf5']['max']) {
							    $w_lsf = 'text-danger';
							}
					    ...
					    ?>
					        <tr>
					            ...
					            <td><?php echo $bf; ?></td>
					            <td class="<?php echo $w_90u; ?>"><?php echo $d['kf90u']; ?></td>
					            <td class="<?php echo $w_180u; ?>"><?php echo $d['kf180u']; ?></td>
					            <td class="<?php echo $w_h2o; ?>"><?php echo $d['H2O']; ?></td>
					            ...
					            <td><?php echo $d['arah_BHF']; ?></td>
					            <td><?php echo $d['LEVEL_cf']; ?></td>
					            <td><?php echo $d['FEED_kiln']; ?></td>
					            <td><?php echo $d['FEED_fc']; ?></td>
					            <td><?php echo $ton_emisi; ?></td>
					            ...
					            <td align="center">
					                ...
					                <a href="del-kf.php?delId=<?php echo $d['id']; ?>" type="button" class="btn btn-danger" style="height:34px" onClick="return confirm('Are you sure to delete this data?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
					            </td>
					        </tr>
					            ...
					            <div class="modal-dialog">
									...
									<div class="modal-body">
										<form role="form" action="" method="get">
											...
											<?php
											$id = $d['id'];
											$sql = "SELECT * FROM kf_5 where id ='$id' ";
											...
											?>
												...
												<div class="form-group row my-0">
													<label for="kf90u" class="col-sm-4 col-form-label">90u</label>
													<div class="col-sm-8">
														<input type="text" style="height:30px" class="form-control" id="kf90u_e" name="kf90u_e" value="<?= $row['kf90u']; ?>">
													</div>
												</div>

												<div class="form-group row my-0">
													<label for="kf180u" class="col-sm-4 col-form-label">180u</label>
													<div class="col-sm-8">
														<input type="text" style="height:30px" class="form-control" id="kf180u_e" name="kf180u_e" value="<?= $row['kf180u']; ?>">
													</div>
												</div>
												<div class="form-group row my-0">
												...
												<div class="form-group row my-0">
												    <label for="arah_BHF" class="col-sm-4 col-form-label">ARAH BHF</label>
												    <div class="col-sm-8">
												        <select name="arah_BHF_e" id="arah_BHF_e" style="height:30px" class="form-control">
												            <option value=""></option> 
												            <option value="SILO" <?= ($row['arah_BHF'] == 'SILO') ? 'selected' : '' ?>>SILO</option>
												            <option value="KILN" <?= ($row['arah_BHF'] == 'KILN') ? 'selected' : '' ?>>KILN</option>
												           
												        </select>
												    </div>
												</div>
												<div class="form-group row my-0">
												    <label for="LEVEL_cf" class="col-sm-4 col-form-label">LEVEL CF SILO</label>
												    <div class="col-sm-8">
												        <input type="text" style="height:30px" class="form-control" id="LEVEL_cf_e" name="LEVEL_cf_e" value="<?= $row['LEVEL_cf']; ?>">
												    </div>
												</div>
												<div class="form-group row my-0">
												    <label for="FEED_kiln" class="col-sm-4 col-form-label">FEED KILN</label>
												    <div class="col-sm-8">
												        <input type="text" style="height:30px" class="form-control" id="FEED_kiln_e" name="FEED_kiln_e" value="<?= $row['FEED_kiln']; ?>">
												    </div>
												</div>
												<div class="form-group row my-0">
												    <label for="FEED_fc" class="col-sm-4 col-form-label">FEED FC</label>
												    <div class="col-sm-8">
												        <input type="text" style="height:30px" class="form-control" id="FEED_fc_e" name="FEED_fc_e" value="<?= $row['FEED_fc']; ?>">
												    </div>
												</div>
	...
	$kf90u = !empty($_POST['kf90u']) ? $_POST['kf90u'] : NULL;
	$kf180u = !empty($_POST['kf180u']) ? $_POST['kf180u'] : NULL;
	...
	$arah_BHF = !empty($_POST['arah_BHF']) ? $_POST['arah_BHF'] : NULL;
	$LEVEL_cf = !empty($_POST['LEVEL_cf']) ? $_POST['LEVEL_cf'] : NULL;
	$FEED_kiln = !empty($_POST['FEED_kiln']) ? $_POST['FEED_kiln'] : NULL;
	$FEED_fc = !empty($_POST['FEED_fc']) ? $_POST['FEED_fc'] : NULL;
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					if (isset($_POST['submit'])) {
					    ...
					    $sql = "INSERT INTO kf_5 (TANGGAL, JAM, kf90u, kf180u, H2O, SiO2, Al2O3, Fe2O3, CaO, MgO, SO3, K2O, Na2O, Cl2, arah_BHF, LEVEL_cf, FEED_kiln, FEED_fc, waktu, iduser) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

					    $stmt = mysqli_prepare($conn, $sql);

					    if ($stmt) {

					        mysqli_stmt_bind_param($stmt, "ssssssssssssssssssss", $tanggal, $JAM, $kf90u, $kf180u, $H2O, $SiO2, $Al2O3, $Fe2O3, $CaO, $MgO, $SO3, $K2O, $Na2O, $Cl2, $arah_BHF, $LEVEL_cf, $FEED_kiln, $FEED_fc, $waktu, $username);
					...
					$sql = "SELECT * FROM kf_5 ORDER BY TANGGAL DESC";
					$q = mysqli_query($conn, $sql);
					?>
					...
					<div class="container">
						<form method="POST" onsubmit="return validateForm()">
							...
							<div class="form-group row my-0">
								<label for="kf90u" class="col-sm-4 col-form-label">90u</label>
								<div class="col-sm-8">
									<input type="text" style="height:30px" class="form-control" id="kf90u" name="kf90u" placeholder="Enter 90u" >
								</div>
							</div>
							<div class="form-group row my-0">
								<label for="kf180u" class="col-sm-4 col-form-label">180u</label>
								<div class="col-sm-8">
									<input type="text" style="height:30px" class="form-control" id="kf180u" name="kf180u" placeholder="Enter 180u">
								</div>
							</div>
							<div class="form-group row my-0">
							    <label for="H2O" class="col-sm-4 col-form-label">H2O</label>
							...
							<div class="form-group row my-0">
							    <label for="arah_BHF" class="col-sm-4 col-form-label">ARAH BHF</label>
							    <div class="col-sm-8">
							        <select name="arah_BHF" id="arah_BHF" style="height:30px" class="form-control">
			                            <option value="" ></option>
							...
							<div class="form-group row my-0">
							    <label for="LEVEL_cf" class="col-sm-4 col-form-label">LEVEL CF SILO</label>
							    <div class="col-sm-8">
							        <input type="text" style="height:30px" class="form-control" id="LEVEL_cf" name="LEVEL_cf" >
							    </div>
							</div>
							<div class="form-group row my-0">
							    <label for="FEED_kiln" class="col-sm-4 col-form-label">FEED KILN</label>
							    <div class="col-sm-8">
							        <input type="text" style="height:30px" class="form-control" id="FEED_kiln" name="FEED_kiln"  >
							    </div>
							</div>
							<div class="form-group row my-0">
							    <label for="FEED_fc" class="col-sm-4 col-form-label">FEED FC</label>
							    <div class="col-sm-8">
							        <input type="text" style="height:30px" class="form-control" id="FEED_fc" name="FEED_fc" >
							    </div>
							</div>
							<div class="form-group mt-4">
							<div class="form-group mt-4">
	...
	<script>
	    function validateForm() {
	    	var kf90u = document.getElementById("kf90u").value;
	        var kf180u = document.getElementById("kf180u").value;
	        ...
	        var FEED_kiln = document.getElementById("FEED_kiln").value;
	        var FEED_fc = document.getElementById("FEED_fc").value

	        var inputs = [kf90u,kf180u,SiO2, Al2O3, Fe2O3, CaO, MgO, SO3, K2O, Na2O, Cl2, H2O, FEED_kiln, FEED_fc];
