        ...
        <table class="table table-striped table-bordered table-hover" id="bhf">
            <thead>
                    <tr class="text-center" >
                        <th  rowspan="1" ></th><th colspan="3">EP</th><th colspan="11">OKSIDA</th> <th colspan="2">STATUS</th><th colspan="1"></th>
                    </tr>

                    <tr class="bg-primary text-white">
                        
                        <th>Tanggal</th><th>LSF</th> <th>SIM</th> <th>ALM</th><th>SiO2</th> <th>Al2O3</th> <th>Fe2O3</th> <th>CaO</th> <th>MgO</th> <th>SO3</th> <th>K2O</th> <th>Na2O</th> <th>Cl2</th><th>SUM</th><th>Alkali</th><th>5R1</th><th>5R2</th> <th>Report</th>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM ep_5 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
