        ...
        <table class="table table-striped table-bordered table-hover" id="z1">
            <thead>
                    <tr class="text-center" >
                        <th rowspan="2" class="freeze1">TANGGAL</th><th rowspan="2" class="freeze2">JAM</th><th rowspan="2" class="freeze3">BIN FLY ASH</th><th rowspan="2" class="freeze4">EMISI CO2 (TON)</th> <th rowspan="2" class="freeze5">TOTAL FEED</th> <th colspan="6">OPC(UltraPro)</th><th  colspan="9">OKSIDA</th><th colspan="4">PROPORSI</th><th colspan="2">ESTIMASI</th><th rowspan="2" >ALKALI OPC</th><th rowspan="2" >TYPE</th> <th rowspan="2" >SILO</th><th colspan="4">PCC(EzPro)</th><th colspan="9">OKSIDA</th><th colspan="4">PROPORSI</th><th colspan="2">ESTIMASI</th><th rowspan="2" >SILO</th><th colspan="4">PCC+(PwrPro)</th><th colspan="9">OKSIDA</th><th colspan="4">PROPORSI</th><th colspan="2">ESTIMASI</th><th rowspan="2" >SILO</th>
                    </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM z1_6 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
