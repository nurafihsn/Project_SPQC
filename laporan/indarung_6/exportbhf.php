        ...
        <table class="table table-striped table-bordered table-hover" id="bhf">
            <thead>
                    <tr class="text-center" >
                        <th  rowspan="1" ></th><th colspan="3">BHF</th><th colspan="10">OKSIDA</th> <th colspan="1">STATUS</th><th colspan="1"></th>
                    </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM bhf_6 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
