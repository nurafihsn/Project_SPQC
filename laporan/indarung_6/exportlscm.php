...
<html>
<head>
   <title>LIMESTONE CM indarung 6 <?php
        ...
        <table class="table table-striped table-bordered table-hover" id="lscm">
            <thead>
                ...
                <tr class="bg-primary text-white">
                        ...
                        <th>Tanggal</th><th>SHIFT</th><th>LSF</th> <th>SIM</th> <th>ALM</th><th>SiO2</th> <th>Al2O3</th> <th>Fe2O3</th> <th>CaO</th> <th>MgO</th> <th>SO3</th> <th>K2O</th> <th>Na2O</th> <th>Cl2</th><th>SUM</th><th>Alkali</th><th>H2O LS</th> <th>H2O PZ</th> <th>H2O GYPS</th><th>Jenis GYPS</th> <th>Report</th>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM lscm_6 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
