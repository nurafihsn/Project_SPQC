...
<body>
<div class="container">
    <h2>STORAGE LS Si Tinggi Indarung 4 </h2>
        ...
        <table class="table table-striped table-bordered table-hover" id="ss">
            <thead>
                    <tr class="text-center" >
                        <th  rowspan="1" ></th><th colspan="3">LS Si Tinggi </th><th colspan="10">OKSIDA</th> <th colspan="1"></th><th colspan="1"></th>
                    </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM ssstg_4 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
