        ...
        <table class="table table-striped table-bordered table-hover" id="ss">
            <thead>
                    <tr class="text-center" >
                        <th  rowspan="1" ></th><th colspan="3">SILICA STONE</th><th colspan="10">OKSIDA</th> <th colspan="1"></th><th colspan="1"></th><th colspan="2"></th>
                    </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM ss_4 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
