        ...
        <table class="table table-striped table-bordered table-hover" id="cr">
            <thead>
                    <tr class="text-center" >
                         <th colspan="2"></th><th  colspan="9">CLINKER</th><th  colspan="11">OKISDA</th><th colspan="1"></th><th colspan="8"></th><th colspan="2">VISUAL</th> <th colspan="2">PENGISIAN</th><th colspan="3">SIEVE 1.18mm</th><th colspan="2"></th>
                    </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM  WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
            ...
            while ($d = mysqli_fetch_array($q)) {
                ...
                <tr>   
                                ...
                                <td><?php echo htmlspecialchars($d['LP']); ?></td>
					            <td><?php echo htmlspecialchars($d['CI']); ?></td>
					            <td><?php echo htmlspecialchars($d['GI']); ?></td>
					            <td><?php echo htmlspecialchars($d['BF']); ?></td>
					            <td><?php echo htmlspecialchars($d['BI']); ?></td>
					            <td><?php echo htmlspecialchars($d['ASR']); ?></td>
					            <td><?php echo htmlspecialchars($d['DoS']); ?></td>
					            <td><?php echo htmlspecialchars($d['EstBZT']); ?></td>
