...
<div class="container">
    ...
    <div class="data-tables datatable-dark">
        ...
        <table class="table table-striped table-bordered table-hover" id="z1">
            <thead>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM z2_4 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
            ...
            while ($d = mysqli_fetch_array($q)) {
                ...
                <tr>   
                      <td class="freeze1"><?php echo htmlspecialchars($d['TANGGAL']); ?></td>
					            ...
					            <td class="freeze5"><?php echo htmlspecialchars($d['EMISI']); ?></td>
