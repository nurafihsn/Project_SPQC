    ...
    <div class="data-tables datatable-dark">
        ...
        <table class="table table-striped table-bordered table-hover" id="ls">
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM ls_4 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
                    $sql = "SELECT * FROM ls_4 WHERE TANGGAL = CURDATE() ";
                    }     
