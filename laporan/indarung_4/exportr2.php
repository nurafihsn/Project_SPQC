        ...
        <table class="table table-striped table-bordered table-hover" id="r1">
            <thead>
                <tr class="text-center" >
			            <th colspan="2"></th><th  colspan="6">4R2</th><th  colspan="4">Proposi Actual</th><th colspan="1">TON</th><th colspan="4">Setpoint QCX, %Wet</th><th colspan="4">Proporsi SET POINT</th> <th colspan="12">OKSIDA</th><th colspan="1">TON</th><th colspan="4">LS BACK</th><th colspan="1"></th>
			        </tr>
            ...
            if(isset($_GET['awal']) && isset($_GET['akhir'])){
                $awal = $_GET['awal'];
                $akhir = $_GET['akhir'];
                $sql = "SELECT * FROM r2_4 WHERE TANGGAL BETWEEN '$awal' AND '$akhir'";
                    } 
            else {  
